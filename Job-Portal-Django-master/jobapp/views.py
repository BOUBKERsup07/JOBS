...
def contact_view(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()  # Enregistre les données dans la base
...
from django.core.cache import cache
from django.core.paginator import Paginator
from .models import Job  # Assurez-vous d'importer le modèle Job
...
def single_job_view(request, id):
    ...
    if cache.get(id):
        ...
        #cache.set(id, job, 60 * 15)  # Cache the job for 15 minutes
